...
CIRCUIT_REGISTRY: dict[str, dict] = {
    # ── 2025 ──────────────────────────────────────────────────────────────────
    "2025_1":  {"total_laps": 58, "base_lap_time_ms": 81_000, "race_name": "Australian Grand Prix",         "circuit_id": "albert_park"},
    "2025_2":  {"total_laps": 56, "base_lap_time_ms": 96_500, "race_name": "Chinese Grand Prix",            "circuit_id": "shanghai"},
    "2025_3":  {"total_laps": 53, "base_lap_time_ms": 93_500, "race_name": "Japanese Grand Prix",           "circuit_id": "suzuka"},
    "2025_4":  {"total_laps": 57, "base_lap_time_ms": 95_800, "race_name": "Bahrain Grand Prix",            "circuit_id": "bahrain"},
    "2025_5":  {"total_laps": 50, "base_lap_time_ms": 90_800, "race_name": "Saudi Arabian Grand Prix",      "circuit_id": "jeddah"},
    "2025_6":  {"total_laps": 57, "base_lap_time_ms": 91_500, "race_name": "Miami Grand Prix",              "circuit_id": "miami"},
    "2025_7":  {"total_laps": 63, "base_lap_time_ms": 79_500, "race_name": "Emilia Romagna Grand Prix",     "circuit_id": "imola"},
    "2025_8":  {"total_laps": 78, "base_lap_time_ms": 75_000, "race_name": "Monaco Grand Prix",             "circuit_id": "monaco"},
    "2025_9":  {"total_laps": 66, "base_lap_time_ms": 83_500, "race_name": "Spanish Grand Prix",            "circuit_id": "catalunya"},
    "2025_10": {"total_laps": 70, "base_lap_time_ms": 76_000, "race_name": "Canadian Grand Prix",           "circuit_id": "villeneuve"},
    "2025_11": {"total_laps": 71, "base_lap_time_ms": 68_500, "race_name": "Austrian Grand Prix",           "circuit_id": "red_bull_ring"},
    "2025_12": {"total_laps": 52, "base_lap_time_ms": 92_500, "race_name": "British Grand Prix",            "circuit_id": "silverstone"},
    "2025_13": {"total_laps": 44, "base_lap_time_ms": 108_000,"race_name": "Belgian Grand Prix",            "circuit_id": "spa"},
    "2025_14": {"total_laps": 70, "base_lap_time_ms": 80_500, "race_name": "Hungarian Grand Prix",          "circuit_id": "hungaroring"},
    "2025_15": {"total_laps": 72, "base_lap_time_ms": 74_000, "race_name": "Dutch Grand Prix",              "circuit_id": "zandvoort"},
    "2025_16": {"total_laps": 53, "base_lap_time_ms": 83_000, "race_name": "Italian Grand Prix",            "circuit_id": "monza"},
    "2025_17": {"total_laps": 51, "base_lap_time_ms": 106_000,"race_name": "Azerbaijan Grand Prix",         "circuit_id": "baku"},
    "2025_18": {"total_laps": 62, "base_lap_time_ms": 102_000,"race_name": "Singapore Grand Prix",          "circuit_id": "marina_bay"},
    "2025_19": {"total_laps": 56, "base_lap_time_ms": 100_500,"race_name": "United States Grand Prix",      "circuit_id": "americas"},
    "2025_20": {"total_laps": 71, "base_lap_time_ms": 80_000, "race_name": "Mexico City Grand Prix",        "circuit_id": "rodriguez"},
    "2025_21": {"total_laps": 71, "base_lap_time_ms": 74_000, "race_name": "São Paulo Grand Prix",          "circuit_id": "interlagos"},
    "2025_22": {"total_laps": 50, "base_lap_time_ms": 100_000,"race_name": "Las Vegas Grand Prix",          "circuit_id": "las_vegas"},
    "2025_23": {"total_laps": 57, "base_lap_time_ms": 88_500, "race_name": "Qatar Grand Prix",              "circuit_id": "losail"},
    "2025_24": {"total_laps": 55, "base_lap_time_ms": 95_500, "race_name": "Abu Dhabi Grand Prix",          "circuit_id": "yas_marina"},
    # ── 2024 ──────────────────────────────────────────────────────────────────
    "2024_1":  {"total_laps": 58, "base_lap_time_ms": 81_200, "race_name": "Australian Grand Prix",         "circuit_id": "albert_park"},
    "2024_2":  {"total_laps": 57, "base_lap_time_ms": 96_000, "race_name": "Bahrain Grand Prix",            "circuit_id": "bahrain"},
    "2024_3":  {"total_laps": 50, "base_lap_time_ms": 91_000, "race_name": "Saudi Arabian Grand Prix",      "circuit_id": "jeddah"},
    "2024_4":  {"total_laps": 53, "base_lap_time_ms": 93_800, "race_name": "Japanese Grand Prix",           "circuit_id": "suzuka"},
    "2024_5":  {"total_laps": 56, "base_lap_time_ms": 97_000, "race_name": "Chinese Grand Prix",            "circuit_id": "shanghai"},
    "2024_6":  {"total_laps": 57, "base_lap_time_ms": 91_800, "race_name": "Miami Grand Prix",              "circuit_id": "miami"},
    "2024_7":  {"total_laps": 63, "base_lap_time_ms": 79_800, "race_name": "Emilia Romagna Grand Prix",     "circuit_id": "imola"},
    "2024_8":  {"total_laps": 78, "base_lap_time_ms": 75_200, "race_name": "Monaco Grand Prix",             "circuit_id": "monaco"},
    "2024_9":  {"total_laps": 66, "base_lap_time_ms": 83_800, "race_name": "Spanish Grand Prix",            "circuit_id": "catalunya"},
    "2024_10": {"total_laps": 70, "base_lap_time_ms": 76_200, "race_name": "Canadian Grand Prix",           "circuit_id": "villeneuve"},
    "2024_11": {"total_laps": 71, "base_lap_time_ms": 68_800, "race_name": "Austrian Grand Prix",           "circuit_id": "red_bull_ring"},
    "2024_12": {"total_laps": 52, "base_lap_time_ms": 92_800, "race_name": "British Grand Prix",            "circuit_id": "silverstone"},
    "2024_13": {"total_laps": 44, "base_lap_time_ms": 108_500,"race_name": "Belgian Grand Prix",            "circuit_id": "spa"},
    "2024_14": {"total_laps": 70, "base_lap_time_ms": 80_800, "race_name": "Hungarian Grand Prix",          "circuit_id": "hungaroring"},
    "2024_15": {"total_laps": 72, "base_lap_time_ms": 74_200, "race_name": "Dutch Grand Prix",              "circuit_id": "zandvoort"},
    "2024_16": {"total_laps": 53, "base_lap_time_ms": 83_500, "race_name": "Italian Grand Prix",            "circuit_id": "monza"},
    "2024_17": {"total_laps": 51, "base_lap_time_ms": 106_500,"race_name": "Azerbaijan Grand Prix",         "circuit_id": "baku"},
    "2024_18": {"total_laps": 62, "base_lap_time_ms": 102_500,"race_name": "Singapore Grand Prix",          "circuit_id": "marina_bay"},
    "2024_19": {"total_laps": 56, "base_lap_time_ms": 101_000,"race_name": "United States Grand Prix",      "circuit_id": "americas"},
    "2024_20": {"total_laps": 71, "base_lap_time_ms": 80_500, "race_name": "Mexico City Grand Prix",        "circuit_id": "rodriguez"},
    "2024_21": {"total_laps": 71, "base_lap_time_ms": 74_500, "race_name": "São Paulo Grand Prix",          "circuit_id": "interlagos"},
    "2024_22": {"total_laps": 50, "base_lap_time_ms": 100_500,"race_name": "Las Vegas Grand Prix",          "circuit_id": "las_vegas"},
    "2024_23": {"total_laps": 57, "base_lap_time_ms": 89_000, "race_name": "Qatar Grand Prix",              "circuit_id": "losail"},
    "2024_24": {"total_laps": 55, "base_lap_time_ms": 95_800, "race_name": "Abu Dhabi Grand Prix",          "circuit_id": "yas_marina"},
    # ── 2023 ──────────────────────────────────────────────────────────────────
    "2023_1":  {"total_laps": 57, "base_lap_time_ms": 96_200, "race_name": "Bahrain Grand Prix",            "circuit_id": "bahrain"},
    "2023_2":  {"total_laps": 50, "base_lap_time_ms": 91_200, "race_name": "Saudi Arabian Grand Prix",      "circuit_id": "jeddah"},
    "2023_3":  {"total_laps": 58, "base_lap_time_ms": 81_500, "race_name": "Australian Grand Prix",         "circuit_id": "albert_park"},
    "2023_4":  {"total_laps": 53, "base_lap_time_ms": 94_000, "race_name": "Japanese Grand Prix",           "circuit_id": "suzuka"},
    "2023_5":  {"total_laps": 57, "base_lap_time_ms": 92_000, "race_name": "Miami Grand Prix",              "circuit_id": "miami"},
    "2023_6":  {"total_laps": 66, "base_lap_time_ms": 84_000, "race_name": "Spanish Grand Prix",            "circuit_id": "catalunya"},
    "2023_7":  {"total_laps": 78, "base_lap_time_ms": 75_500, "race_name": "Monaco Grand Prix",             "circuit_id": "monaco"},
    "2023_8":  {"total_laps": 70, "base_lap_time_ms": 76_500, "race_name": "Canadian Grand Prix",           "circuit_id": "villeneuve"},
    "2023_9":  {"total_laps": 63, "base_lap_time_ms": 80_000, "race_name": "Emilia Romagna Grand Prix",     "circuit_id": "imola"},
    "2023_10": {"total_laps": 51, "base_lap_time_ms": 107_000,"race_name": "Azerbaijan Grand Prix",         "circuit_id": "baku"},
    "2023_11": {"total_laps": 52, "base_lap_time_ms": 93_000, "race_name": "British Grand Prix",            "circuit_id": "silverstone"},
    "2023_12": {"total_laps": 71, "base_lap_time_ms": 69_000, "race_name": "Austrian Grand Prix",           "circuit_id": "red_bull_ring"},
    "2023_13": {"total_laps": 44, "base_lap_time_ms": 109_000,"race_name": "Belgian Grand Prix",            "circuit_id": "spa"},
    "2023_14": {"total_laps": 70, "base_lap_time_ms": 81_000, "race_name": "Hungarian Grand Prix",          "circuit_id": "hungaroring"},
    "2023_15": {"total_laps": 72, "base_lap_time_ms": 74_500, "race_name": "Dutch Grand Prix",              "circuit_id": "zandvoort"},
    "2023_16": {"total_laps": 53, "base_lap_time_ms": 84_000, "race_name": "Italian Grand Prix",            "circuit_id": "monza"},
    "2023_17": {"total_laps": 62, "base_lap_time_ms": 103_000,"race_name": "Singapore Grand Prix",          "circuit_id": "marina_bay"},
    "2023_18": {"total_laps": 56, "base_lap_time_ms": 101_500,"race_name": "United States Grand Prix",      "circuit_id": "americas"},
    "2023_19": {"total_laps": 71, "base_lap_time_ms": 81_000, "race_name": "Mexico City Grand Prix",        "circuit_id": "rodriguez"},
    "2023_20": {"total_laps": 71, "base_lap_time_ms": 75_000, "race_name": "São Paulo Grand Prix",          "circuit_id": "interlagos"},
    "2023_21": {"total_laps": 50, "base_lap_time_ms": 100_800,"race_name": "Las Vegas Grand Prix",          "circuit_id": "las_vegas"},
    "2023_22": {"total_laps": 57, "base_lap_time_ms": 89_500, "race_name": "Qatar Grand Prix",              "circuit_id": "losail"},
    "2023_23": {"total_laps": 55, "base_lap_time_ms": 96_000, "race_name": "Abu Dhabi Grand Prix",          "circuit_id": "yas_marina"},
    # ── 2022 ──────────────────────────────────────────────────────────────────
    "2022_1":  {"total_laps": 57, "base_lap_time_ms": 97_000, "race_name": "Bahrain Grand Prix",            "circuit_id": "bahrain"},
    "2022_2":  {"total_laps": 50, "base_lap_time_ms": 92_000, "race_name": "Saudi Arabian Grand Prix",      "circuit_id": "jeddah"},
    "2022_3":  {"total_laps": 58, "base_lap_time_ms": 82_000, "race_name": "Australian Grand Prix",         "circuit_id": "albert_park"},
    "2022_4":  {"total_laps": 63, "base_lap_time_ms": 80_500, "race_name": "Emilia Romagna Grand Prix",     "circuit_id": "imola"},
    "2022_5":  {"total_laps": 57, "base_lap_time_ms": 92_500, "race_name": "Miami Grand Prix",              "circuit_id": "miami"},
    "2022_6":  {"total_laps": 66, "base_lap_time_ms": 84_500, "race_name": "Spanish Grand Prix",            "circuit_id": "catalunya"},
    "2022_7":  {"total_laps": 78, "base_lap_time_ms": 76_000, "race_name": "Monaco Grand Prix",             "circuit_id": "monaco"},
    "2022_8":  {"total_laps": 70, "base_lap_time_ms": 77_000, "race_name": "Canadian Grand Prix",           "circuit_id": "villeneuve"},
    "2022_9":  {"total_laps": 51, "base_lap_time_ms": 108_000,"race_name": "Azerbaijan Grand Prix",         "circuit_id": "baku"},
    "2022_10": {"total_laps": 52, "base_lap_time_ms": 93_500, "race_name": "British Grand Prix",            "circuit_id": "silverstone"},
    "2022_11": {"total_laps": 71, "base_lap_time_ms": 69_500, "race_name": "Austrian Grand Prix",           "circuit_id": "red_bull_ring"},
    "2022_12": {"total_laps": 53, "base_lap_time_ms": 94_500, "race_name": "Japanese Grand Prix",           "circuit_id": "suzuka"},
    "2022_13": {"total_laps": 44, "base_lap_time_ms": 110_000,"race_name": "Belgian Grand Prix",            "circuit_id": "spa"},
    "2022_14": {"total_laps": 70, "base_lap_time_ms": 81_500, "race_name": "Hungarian Grand Prix",          "circuit_id": "hungaroring"},
    "2022_15": {"total_laps": 72, "base_lap_time_ms": 75_000, "race_name": "Dutch Grand Prix",              "circuit_id": "zandvoort"},
    "2022_16": {"total_laps": 53, "base_lap_time_ms": 84_500, "race_name": "Italian Grand Prix",            "circuit_id": "monza"},
    "2022_17": {"total_laps": 62, "base_lap_time_ms": 103_500,"race_name": "Singapore Grand Prix",          "circuit_id": "marina_bay"},
    "2022_18": {"total_laps": 56, "base_lap_time_ms": 102_000,"race_name": "United States Grand Prix",      "circuit_id": "americas"},
    "2022_19": {"total_laps": 71, "base_lap_time_ms": 81_500, "race_name": "Mexico City Grand Prix",        "circuit_id": "rodriguez"},
    "2022_20": {"total_laps": 71, "base_lap_time_ms": 75_500, "race_name": "São Paulo Grand Prix",          "circuit_id": "interlagos"},
    "2022_21": {"total_laps": 55, "base_lap_time_ms": 96_500, "race_name": "Abu Dhabi Grand Prix",          "circuit_id": "yas_marina"},
}
...
COMPOUND_DELTA_MS: dict[str, float] = {
    "SOFT": 0.0, "MEDIUM": 400.0, "HARD": 800.0, "INTER": 1_500.0, "WET": 2_500.0,
}
DEG_RATE_MS: dict[str, float] = {
    "SOFT": 80.0, "MEDIUM": 50.0, "HARD": 30.0, "INTER": 60.0, "WET": 40.0,
}
...
class RaceRunner:
    ...
    def __init__(
        ...
        self._total_laps       = total_laps       or (_reg["total_laps"]       if _reg else self._load_total_laps())
        self._base_lap_time_ms = base_lap_time_ms or (_reg["base_lap_time_ms"] if _reg else self._load_base_lap_time())
    ...
    def step_lap(self, user_action: int) -> tuple[dict[str, LapRecord], np.ndarray, dict]:
        """
        Advance one lap.
        ...
        model_states = {d.driver_id: self._model_state_dict(self._states[d.driver_id])
                        for d in active}
        ...
        if hasattr(td_adapter, "predict_batch") and td_adapter.loaded:
            ...
            tire_deltas = {did: td_adapter.predict(ms) for did, ms in zip(id_list, ms_list)}
        ...
        if hasattr(fuel_adapter, "predict_batch") and fuel_adapter.loaded:
            ...
            fuel_burns = {did: fuel_adapter.predict(ms) for did, ms in zip(id_list, ms_list)}
    ...
    def result(self) -> RaceResult:
            ...
            [
                {
                    ...
                    "gap_to_winner_s": round(
                        (s.cumulative_time_ms - min(x.cumulative_time_ms for x in self._states.values())) / 1000.0, 3
                    ),
                }
        ...
        return RaceResult(
            ...
            user_final_position = self._states[self._user_id].position if self._user_id else 0,
    ...
    def _ai_action(self, state: DriverRaceState) -> int:
        ...
        if state.safety_car and tire_age > 8:
            ...
            pit_prob = self._sc_adapter().predict_pit(model_state) if self._sc_adapter().loaded else 0.0
            threshold = 0.45 - 0.1 * tire_mgmt   # conservative managers need higher confidence
            if pit_prob > threshold or tire_age > COMPOUND_OPTIMAL_LAPS.get(compound, 30) * 0.8:
        ...
        if state.pit_stops == 0 and 0.35 <= laps_pct <= 0.52 and tire_age >= int(optimal * 0.75):
            # Small stochastic chance to pit in strategic window
            if self._rng.random() < 0.06 + 0.04 * aggression:
                return _choose_compound_action(laps_rem, aggression)

        if state.pit_stops == 1 and 0.65 <= laps_pct <= 0.80 and tire_age >= int(optimal * 0.70):
    ...
    def _compute_lap_time(
        ...
        lap_time_ms = (
            base_ms + compound_delta + deg_ms + mode_delta
            + sc_delta + pit_loss + pressure_delta + noise_ms
        )
    ...
    def _update_positions(self, lap_records: dict[str, LapRecord]) -> None:
        ...
        for rank, s in enumerate(sorted_states, start=1):
            ...
            s.gap_to_ahead  = max(0.0, (s.cumulative_time_ms - times[rank - 2]) / 1000.0) if rank > 1 else 0.0
...
def _extract_stints(lap_records: list[LapRecord]) -> list[dict]:
    ...
    for rec in lap_records:
        if rec.pit_stop and rec.new_compound:
            stints.append({"compound": current_compound, "laps": rec.lap_number - stint_start})
