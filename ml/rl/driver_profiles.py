...
DRIVER_PROFILES: dict[str, dict[str, float]] = {
    # Red Bull
    "max_verstappen":    {"aggression": 0.88, "consistency": 0.96, "tire_management": 0.82, "pressure_response": 0.93},
    "sergio_perez":      {"aggression": 0.68, "consistency": 0.82, "tire_management": 0.91, "pressure_response": 0.70},
    # McLaren
    "lando_norris":      {"aggression": 0.79, "consistency": 0.84, "tire_management": 0.76, "pressure_response": 0.76},
    "oscar_piastri":     {"aggression": 0.77, "consistency": 0.85, "tire_management": 0.79, "pressure_response": 0.74},
    # Ferrari
    "charles_leclerc":   {"aggression": 0.83, "consistency": 0.84, "tire_management": 0.72, "pressure_response": 0.81},
    "lewis_hamilton":    {"aggression": 0.76, "consistency": 0.92, "tire_management": 0.91, "pressure_response": 0.88},
    # Mercedes
    "george_russell":    {"aggression": 0.74, "consistency": 0.88, "tire_management": 0.81, "pressure_response": 0.77},
    "kimi_antonelli":    {"aggression": 0.75, "consistency": 0.76, "tire_management": 0.72, "pressure_response": 0.70},
    # Aston Martin
    "fernando_alonso":   {"aggression": 0.77, "consistency": 0.90, "tire_management": 0.88, "pressure_response": 0.87},
    "lance_stroll":      {"aggression": 0.65, "consistency": 0.73, "tire_management": 0.75, "pressure_response": 0.62},
    # Alpine
    "pierre_gasly":      {"aggression": 0.72, "consistency": 0.78, "tire_management": 0.74, "pressure_response": 0.71},
    "jack_doohan":       {"aggression": 0.71, "consistency": 0.72, "tire_management": 0.70, "pressure_response": 0.66},
    # Haas
    "oliver_bearman":    {"aggression": 0.74, "consistency": 0.75, "tire_management": 0.71, "pressure_response": 0.68},
    "esteban_ocon":      {"aggression": 0.69, "consistency": 0.77, "tire_management": 0.76, "pressure_response": 0.68},
    # RB (VCARB)
    "yuki_tsunoda":      {"aggression": 0.76, "consistency": 0.73, "tire_management": 0.70, "pressure_response": 0.71},
    "liam_lawson":       {"aggression": 0.74, "consistency": 0.76, "tire_management": 0.72, "pressure_response": 0.70},
    # Sauber
    "nico_hulkenberg":   {"aggression": 0.70, "consistency": 0.80, "tire_management": 0.78, "pressure_response": 0.72},
    "gabriel_bortoleto": {"aggression": 0.72, "consistency": 0.73, "tire_management": 0.70, "pressure_response": 0.67},
    # Williams
    "alex_albon":        {"aggression": 0.71, "consistency": 0.79, "tire_management": 0.77, "pressure_response": 0.72},
    "carlos_sainz":      {"aggression": 0.73, "consistency": 0.86, "tire_management": 0.84, "pressure_response": 0.78},
    # Legends (available for custom races)
    "michael_schumacher":  {"aggression": 0.87, "consistency": 0.95, "tire_management": 0.86, "pressure_response": 0.92},
    "ayrton_senna":        {"aggression": 0.93, "consistency": 0.88, "tire_management": 0.74, "pressure_response": 0.95},
    "alain_prost":         {"aggression": 0.65, "consistency": 0.94, "tire_management": 0.95, "pressure_response": 0.84},
    "sebastian_vettel":    {"aggression": 0.80, "consistency": 0.93, "tire_management": 0.85, "pressure_response": 0.85},
    "valtteri_bottas":     {"aggression": 0.71, "consistency": 0.85, "tire_management": 0.82, "pressure_response": 0.65},
    "isack_hadjar":        {"aggression": 0.73, "consistency": 0.74, "tire_management": 0.71, "pressure_response": 0.68},
}
...
DEFAULT_GRID: list[str] = [
    ...
    "carlos_sainz", "george_russell", "lewis_hamilton", "fernando_alonso",
    "sergio_perez", "kimi_antonelli", "yuki_tsunoda", "liam_lawson",
    "alex_albon", "nico_hulkenberg", "gabriel_bortoleto", "oliver_bearman",
    "esteban_ocon", "pierre_gasly", "lance_stroll", "jack_doohan",
]
...
_GENERIC_PROFILE: dict[str, float] = {
    "aggression": 0.70, "consistency": 0.78,
    "tire_management": 0.75, "pressure_response": 0.70,
}
...
def build_race_lineup(
    ...
    entries.append(DriverEntry(
        ...
        profile        = {k: float(max(0.0, min(1.0, resolved_profile.get(k, 0.5))))
                          for k in ("aggression", "consistency", "tire_management", "pressure_response")},
