...
def test_build_output_counts():
    ...
    deg = {
        ("red_bull", "2024"): {
            "SOFT": {"deg_slope_per_lap": 0.07, "base_deg_s": -1.5, "avg_tyre_delta": -0.7, "r_squared": 0.09, "n_laps": 100},
            "MEDIUM": {"deg_slope_per_lap": 0.04, "base_deg_s": -0.5, "avg_tyre_delta": -0.3, "r_squared": 0.07, "n_laps": 200},
        },
        ("ferrari", "2024"): {
            "SOFT": {"deg_slope_per_lap": 0.08, "base_deg_s": -1.0, "avg_tyre_delta": -0.5, "r_squared": 0.1, "n_laps": 150},
        },
    }
    output = _build_output(pace, deg, _mock_df())
