...
/**
 * Fetches 2025 season race results from the static pipeline data file.
 * File is generated by generate_static_json.py once 2025 data is available.
 */
export function useRaces2025() {
  return useApiCall(() => fetchStaticRaces2025(), [], [], 'races2025');
}

/**
 * Fetches 2026 season race results from the static pipeline data file.
 * File is generated by generate_static_json.py once 2026 data is available.
 */
export function useRaces2026() {
  return useApiCall(() => fetchStaticRaces2026(), [], [], 'races2026');
}
