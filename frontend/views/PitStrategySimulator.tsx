  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 min-h-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {MOCK_STRATEGIES.map((s) => (
              ...
              >
                ...
                <div className="text-xl font-display font-bold text-white">{(s.win_prob * 100).toFixed(1)}% <span className="text-[10px] font-mono text-gray-500">WIN</span></div>
        ...
        <div className="lg:col-span-4 rounded-2xl p-8 border shadow-xl flex flex-col min-h-[500px]" style={{ backgroundColor: 'var(--card-bg)', borderColor: 'var(--border-color)' }}>
