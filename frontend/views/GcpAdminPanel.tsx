...
const GcpAdminPanel: React.FC = () => {
  ...
  const renderGauge = (value: number, label: string, color: string) => {
    return (
      <div className="flex flex-col items-center p-4 bg-black/40 rounded-2xl border" style={{ borderColor: 'var(--border-color)' }}>
        ...
        <span className="text-xs uppercase tracking-widest text-gray-500 mt-3 font-bold">{label}</span>
      </div>
    );
  };
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1 font-mono">GCP Cloud Run & Monitoring Metrics</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-6">
          {/* Hardware Metrics */}
          <div className="bg-[#151515] rounded-3xl p-6 border shadow-xl relative overflow-hidden" style={{ borderColor: 'var(--border-color)' }}>
            ...
            {metricsLoading ? (
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="col-span-2 flex justify-between items-center p-4 bg-black/40 rounded-xl mt-2 border" style={{ borderColor: 'var(--border-color)' }}>
                  <div>
                    <p className="text-[10px] uppercase tracking-widest text-gray-500 mb-1">Active Instances</p>
                    <p className="text-xl font-mono text-white">{metrics.active_instances}</p>
                  </div>
                  <div className="text-right">
                    <p className="text-[10px] uppercase tracking-widest text-gray-500 mb-1">Total Requests</p>
          ...
          <div className="bg-[#151515] rounded-3xl p-6 border shadow-xl relative overflow-hidden" style={{ borderColor: 'var(--border-color)' }}>
            ...
            {quotasLoading ? (
              ...
              <div className="space-y-4">
                <div className="bg-black/40 p-4 rounded-xl border" style={{ borderColor: 'var(--border-color)' }}>
                ...
                <div className="bg-black/40 p-4 rounded-xl border flex justify-between items-center" style={{ borderColor: 'var(--border-color)' }}>
                  <div>
                    <p className="text-[10px] uppercase tracking-widest text-gray-500 mb-1">Cloud Run Status</p>
                    <p className="text-sm font-bold text-white capitalize">{quotas.cloud_run.status}</p>
                  </div>
                  <div className="text-right">
                     <p className="text-[10px] uppercase tracking-widest text-gray-500 mb-1">Compute Seconds</p>
        ...
        {/* Right Column - Logs */}
        <div className="lg:col-span-2 bg-[#151515] flex flex-col rounded-3xl border shadow-xl overflow-hidden" style={{ borderColor: 'var(--border-color)' }}>
          <div className="p-6 border-b bg-black/40 flex items-center justify-between" style={{ borderColor: 'var(--border-color)' }}>
             ...
             {logsLoading ? (
               ...
               <div className="space-y-4">
                 {logsData.logs.map((log, i) => (
                   <div key={i} className="flex gap-4 p-4 rounded-xl border bg-black/60 items-start" style={{ borderColor: 'var(--border-color)' }}>
